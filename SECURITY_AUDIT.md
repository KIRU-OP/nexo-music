...
Files: `nexo/__init__.py`, `nexo/utils/security.py`
...
Files: `nexo/core/call.py`, `nexo/core/git.py`, `nexo/platforms/Youtube.py`, `nexo/plugins/sudo/restart.py`, `nexo/plugins/tools/kang.py`, `nexo/plugins/tools/tiny.py`, `nexo/plugins/tools/videoedit.py`, `nexo/utils/formatters.py`
...
Files: `nexo/logging.py`, `nexo/utils/errors.py`, `nexo/utils/security.py`
...
Files: `nexo/plugins/Kishu/webdl.py`, `nexo/plugins/misc/urlshortner.py`, `nexo/plugins/misc/downloadrepo.py`, `nexo/utils/security.py`
...
File: `nexo/platforms/Youtube.py:239-266`
...
File: `nexo/core/call.py:176-185`
...
File: `nexo/plugins/sudo/restart.py:73-155`
...
## Tests
`python -m py_compile nexo/platforms/Youtube.py`
`python -m py_compile nexo/core/call.py`
`python -m py_compile nexo/plugins/sudo/restart.py`
`python -m py_compile nexo/plugins/tools/videoedit.py nexo/plugins/tools/tiny.py`
